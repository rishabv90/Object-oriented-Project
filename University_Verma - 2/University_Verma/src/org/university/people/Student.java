...
public class Student extends Person{
	...
	public void testAddCourse1(CampusCourse cCourse) {
		...
		if(!cCourse.availableTo(this)) { //maxcourse Limit reached
	...
	public void testDropCourse(CampusCourse cCourse) {
		...
		if((this.getCampusCourseList().contains(cCourse)==true) && (creditsAfterMinus<6 && this.getOnlineCourseList().size()!=0)) { //too few to drop
			...
			System.out.println("The course "+cCourse.getDepartment().getDepartmentName()+cCourse.getCourseNumber()+" could not be dropped because "+this.getName()+" is not enrolled in "+cCourse.getDepartment().getDepartmentName()+cCourse.getCourseNumber()+ ".");
		}else {//drop
